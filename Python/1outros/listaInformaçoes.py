sacola = ['Arroz','Arroz','Arroz', 'Feijão', 'Carne', 'Farinha']
...
# Adiciona todos os itens de outra estrurura ao fim da lista

# sacola_2 = ['macarrão, frango']

# sacola.extend(sacola_2)

# print(f'Lista após a chamada do método EXTEND(): {sacola}')

# MÉTODO: INSERT(indice, objeto)
# Insere um item na posição desejada
# sacola.insert(0, 'macarrão')
...
# MÉTODO: COUNT(valor)
# Conta o numero de occorências em um valor específico

# cont = sacola.count('Arroz')

# print(f'Lista após a chamada do método COUNT: {cont}')
